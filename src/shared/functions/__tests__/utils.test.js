...
it('Retorna um número com formato de moeda', () => {
  ...
  expect(formatMoney('a')).toStrictEqual('0.00');
  expect(formatMoney('a1')).toStrictEqual('0.00');
  expect(formatMoney('a.1')).toStrictEqual('0.00');
  expect(formatMoney('1.a')).toStrictEqual('0.00');
  expect(formatMoney('1,00')).toStrictEqual('0.00');
  expect(formatMoney(-1)).toStrictEqual('-1.00');
  ...
  expect(formatMoney(1.9341565)).toStrictEqual('1.94');
